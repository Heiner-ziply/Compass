...
$pagetitle="Tablespaces";
$headline = '<h1>Oracle Tablespace Usage</h1>' ;
$top_help_text="";
...
$sql = "select replace(global_name,'.WORLD','') global_name, tablespace_name, mb_alloc, pct_used, max_ext_mb,pct_extended pct_ext, autoextensible autoext, pct_full,to_char(poll_date,'DD-MON') as_of from  global_tablespaces where poll_date in (select max(poll_date) from global_tablespaces) order by pct_full desc";
