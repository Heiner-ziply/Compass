...
$headline = '<h1>Oracle ASM disk usage</h1>' ;
$top_help_text="";
...
$sql = "select pct_used,sid, diskgroup,total_mb,free_mb,to_char(poll_date,'YYYY-MON-DD')  as poll_date from  global_asm_diskgroup order by pct_used desc";
