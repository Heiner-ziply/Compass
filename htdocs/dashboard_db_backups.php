...
$headline='<h1>Database Backups</h1>';
//$headline .='<button id="ToggleHelp">Show/hide help</button>';
...
$sql=$sql . ',backup_status as "Backup status" , backup_batch_job_id as "Batch job", backup_job_id "Job ID" from database_directory d left join instance_dbms_oracle o on o.sid=d.servicename'." where upper(d.status)='ACTIVE' and nvl(support_team_id,1)=1 ";
