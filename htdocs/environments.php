...
$sql='select e.app_id as "(filter)", app_name as "Application", e.env_name as "Environment", e.env_class as "Env. type",  e.env_id as "Services", e.env_id as "Databases"   from environment e LEFT JOIN application a ON e.app_id=a.app_id WHERE 1=1 ';
