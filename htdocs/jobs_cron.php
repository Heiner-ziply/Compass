...
$pagetitle="Cron Jobs";
$headline='<h1>cron job directory</h1>';
...
$sql = "select username,hostname, cron_min minute,cron_hour hour,cron_dom day_of_month,cron_mon month,cron_dow day_of_week, cron_cmd command
from load_cron
order by hostname, username, cron_cmd";
